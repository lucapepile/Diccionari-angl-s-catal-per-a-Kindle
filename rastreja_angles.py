...
# Configuració
SORTIDA_HTML = "diccionari_angles_catala.html"
LOG_ERRORS = "errors_angles.log"
NUM_PAGINES = 3833  # Nou nombre de pàgines per al diccionari anglès-català
BASE_URL = "https://www.diccionari.cat/cerca/diccionari-angles-catala?search_api_fulltext_cust=&search_api_fulltext_cust_1=&field_faceta_cerca_1=5057&page="
SLEEP_TIME = 0.5
RETRY_LIMIT = 5
...
<body>
<h1>Entrades del diccionari anglès-català</h1>
""")
...
for i in range(0, NUM_PAGINES):
    ...
    while retry_count < RETRY_LIMIT:
        try:
            ...
            articles = soup.find_all("article", class_="node--type-diccionari-en-ca")
...
print("🎉 Diccionari anglès-català guardat a:", SORTIDA_HTML)
